...
/**
 * Clase para filtrar el Jwt de todas las peticiones realizadas para la aplicacion
 */
@Component
public class JwtFilterRequest extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain) throws ServletException, IOException {
        ...
        //Montaje de las validaciones
        if (authorizationHeader != null && authorizationHeader.startsWith("Bearer")){
            //Desde la peticion 7 viene mi JWT
            String jwt = authorizationHeader.substring(7);
            String username = jwtUtil.extractUsername(jwt);
            //verificar el usuario del JWT si no es nulo y que no haya ingresado a la app
